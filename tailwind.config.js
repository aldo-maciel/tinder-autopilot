...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      none: 'none',
      'gradient-start-btn': 'linear-gradient(to top right, #fd267a, #ff6036);',
    ...
    boxShadow: {
      ...
      none: 'none',
      wrShadow: 'var(--card-shadow)',
      cardShadow: '8px 8px var(--component-background)',
      cardHoverShadow: '8px 8px #409289'
    },
    ...
    fontSize: {
      ...
      '25px': ['1.563rem', { lineHeight: '1.25rem' }],
    ...
    gridTemplateColumns: {
      ...
      card: 'repeat(auto-fill,minmax(390px, 1fr))'
    },
    gridTemplateRows: {
      none: 'none',
      1: 'repeat(1, minmax(0, 1fr))',
